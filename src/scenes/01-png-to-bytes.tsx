...
const insertedLineWidths = [590, 445, 660];
const insertedLineY = [-42, 0, 42];
...
export default makeScene2D(function* (view) {
  ...
  /*
   * HEX TILES → ABSTRACT FILE CONTENTS
   */
  ...
  /*
   * Swap interpretation at edge-on.
   */

  landscape().opacity(0);
  doomScene().opacity(1);
  programTitle().text('Doom');

  /*
   * FLIP BACK OUT AS DOOM
   */
